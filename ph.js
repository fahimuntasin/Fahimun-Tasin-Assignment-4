const jobs = [
  ...
  },
  {
    ...
    status: "not_applied",
    description:
      "Transform complex datasets into clear dashboards and visual reports using D3.js, React, and analytics tools.",
  },
...

  {
    ...
    status: "not_applied",
    description:
      "Develop intuitive interfaces and collaborate with product teams to deliver user-centered digital experiences.",
  },

  {
    ...
    status: "not_applied",
    description:
      "Build enterprise-grade applications using modern JavaScript frameworks. Focus on performance and maintainable code.",
  },
  {
    id: 7,
    company: "StartupXYZ",
    ...
    status: "not_applied",
    description:
      "Work on both frontend and backend systems using React and Node.js. Contribute to architecture decisions in a fast-growing startup.",
  },

  {
    ...
    status: "not_applied",
    description:
      "Lead frontend development using React and TypeScript. Improve UI performance and mentor junior developers.",
  },
];
...
function renderJobs() {
  ...
  filteredJobs.forEach((job) => {
    ...
    const badgeText =
      job.status === "not_applied" ? "NOT APPLIED" : job.status.toUpperCase();
